namespace Loupedeck.LoupeXIVDeck
{
    ...
    // This class implements an example command that test.

    public class FFXIVClassCommand : PluginDynamicCommand
    {
        ...
        public FFXIVClassCommand()
            : base("Trigger Class", "Trigger Class", "FFXIV Commands") => this.MakeProfileAction("tree");
